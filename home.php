...
<body class="body" id="body-soomth">
  ...
  <section class="main-container" id="home">
    <div class="container">
      <header class="header">
        <div id="nav-bar">
          ...
          <ul class="menu">
            ...
            <li class="menu__item"><a class="menu__link" href="registration.php">Register</a></li>
      ...
      <div class="main-title">
        ...
        <a  href="registration.php" style="text-decoration: none;"><div class="button" >Start to play</div></a>
      </div>
    </div>
  </section>
  ...
  <div class="cards-container" id="tres">
    <div class="card">
      ...
      <div class="container-buttons">
        ...
        <div class="button button--card-2">Start to play</div>
      </div>
    </div>
  ...
  <footer class="footer-2">
    ...
    <div class="container-footer-2">
      <p>Develop by <a class="container-footer__link" href="" target="_blank">pavankumar</a> @ 2021</p>
    </div>
  </footer>
  <style>
    .html {
